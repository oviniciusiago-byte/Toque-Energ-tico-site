...
export default function HeroScrub() {
  ...
  return (
    <div
      ref={raizRef}
      data-surface="image"
      className="surface-image relative isolate h-[100svh] overflow-hidden bg-ink text-[color:var(--s-fg)]"
      ...
      <div className="relative flex h-full flex-col justify-end">
        ...
        <div ref={rodapeRef} className="shell pb-8">
          ...
          <div className="flex items-center justify-between gap-6 pt-5">
            ...
            <Star size={14} orbita={false} className="shrink-0 text-[color:var(--s-accent)]" />
          </div>
        </div>
      </div>
    </div>
