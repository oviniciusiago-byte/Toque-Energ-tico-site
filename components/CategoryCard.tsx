    ...
    <Link href={`/catalogo/${categoria.slug}`} className="group block">
      <div className="card-media aspect-[3/4]">
        ...
        <span
          ...
          style={{
            background:
              'linear-gradient(to top, rgb(var(--ink-rgb) / 0.9) 0%, rgb(var(--ink-rgb) / 0.5) 38%, rgb(var(--ink-rgb) / 0.12) 100%)',
          }}
        />
        ...
        <div className="absolute inset-x-0 bottom-0 p-5 text-paper sm:p-6">
          ...
          {quantidade ? (
            <p className="mt-2 font-sans text-[0.66rem] uppercase tracking-[0.18em] text-paper/80">
